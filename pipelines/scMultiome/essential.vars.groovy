...
ESSENTIAL_SEQTYPE="tenXmultiome"  // sequencing type
...
ESSENTIAL_GENOME_REFERENCE="/fsimb/common/genomes/homo_sapiens/10X/grch38_ensembl98/refdata-cellranger-arc-GRCh38-2020-A-2.0.0"
ESSENTIAL_EXPECTED_CELLS=7000 // cellranger default 
ESSENTIAL_NUCLEI="yes"         // set to "yes" if run with nuclei instead of cells 
...
TARGETS= new File(PIPELINE_ROOT + "/pipelines/scMultiome/targets.txt").getCanonicalPath()
CONTRASTS= new File(PIPELINE_ROOT + "/pipelines/scMultiome/contrasts.txt").getCanonicalPath()
