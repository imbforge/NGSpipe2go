...
ESSENTIAL_CALL_REGION="intervals.list" // limit variant calling to a limited region, e.g. exonic sequences or chr3 only. Will save a lot of compute time.
ESSENTIAL_THREADS=4
...
ESSENTIAL_FILTERVARIANTS="hard-filter" // either "VQSR", "hard-filter" or empty (VQSR is recommended for variant filtering if possible)
