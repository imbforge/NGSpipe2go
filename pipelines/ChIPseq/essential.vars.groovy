...
ESSENTIAL_FULLLIBRARYSIZE=true // use total number of reads in bam for normalization in DiffBind analysis (false=only reads overlapping peaks)
...
// filtered branch: remove duplicates and multimappers (MapQ filtered) from BAM file
...
// unfiltered branch: alternative workflow using the unfiltered BAM files
