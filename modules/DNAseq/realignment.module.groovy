...
IndelRealignment = {
    ...
    transform (".bam") to (".realignment.targets.bed", ".realigned.bam") {
        exec """
            ...
            java -Djava.io.tmpdir=$TMPDIR -jar ${TOOL_GATK}/GenomeAnalysisTK.jar -T IndelRealigner -R $GATK_BWA_REF -I $input -targetIntervals $output1 -o $output2;        ""","IndelRealignment"
    }
