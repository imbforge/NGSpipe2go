...
DE_DESeq2_MMATRIX="mmatrix=~group"            //simplified formula, MUST contain the intercept
DE_DESeq2_FILTER="filter=NOTUSED"             //whether to filter invariant genes. NOT USED
...
DE_DESeq2_OUTDIR="out=" + RESULTS + "/DE_DESeq2"   //output filename base pattern
