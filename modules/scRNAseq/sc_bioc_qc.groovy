sc_bioc_qc = {
    ...
    def sc_bioc_qc_FLAGS =
        ...
        (sc_bioc_qc_vars.plot_pointsize     ? " plot_pointsize="     + sc_bioc_qc_vars.plot_pointsize     : "") +
        (sc_bioc_qc_vars.plot_pointalpha    ? " plot_pointalpha="    + sc_bioc_qc_vars.plot_pointalpha    : "")
