sc_bioc_filter = {
    ...
    def sc_bioc_filter_FLAGS =
        ...
        (sc_bioc_filter_vars.plot_pointsize             ? " plot_pointsize="             + sc_bioc_filter_vars.plot_pointsize               : "") +
        (sc_bioc_filter_vars.plot_pointalpha            ? " plot_pointalpha="            + sc_bioc_filter_vars.plot_pointalpha              : "")
