...
DIFFBIND_SUBSTRACTCONTROL="substractControl=TRUE"     // substract input
DIFFBIND_FULLLIBRARYSIZE="fullLibrarySize=TRUE"       // use total number of reads in bam for normalization (FALSE=only peaks)
DIFFBIND_TAGWISEDISPERSION="tagwiseDispersion=TRUE"   // calculate dispersion tagwise (use FALSE if no replicates)
