...
load PIPELINE_ROOT + "/modules/ChIPseq/shinyreports_pe.vars.groovy"
...
shinyReports = {
    ...
    produce("shinyReports.txt") {
        exec """
            ...
            cp ${PIPELINE_ROOT}/tools/reports/shiny_chipseq_pe_reporting_tool/server.R ${REPORTS}                &&
            cp ${PIPELINE_ROOT}/tools/reports/shiny_chipseq_pe_reporting_tool/ui.R ${REPORTS}                    &&
            cp ${PIPELINE_ROOT}/tools/reports/shiny_chipseq_pe_reporting_tool/ChIP.shinyrep.helpers.R ${REPORTS} &&
            cp ${PIPELINE_ROOT}/tools/reports/shiny_chipseq_pe_reporting_tool/bustard.pl ${REPORTS}              &&
            cp ${PIPELINE_ROOT}/tools/reports/shiny_chipseq_pe_reporting_tool/BustardSummary.toMD.xsl ${REPORTS} &&
            cp ${PIPELINE_ROOT}/tools/reports/shiny_chipseq_pe_reporting_tool/styles.css ${REPORTS}              &&
