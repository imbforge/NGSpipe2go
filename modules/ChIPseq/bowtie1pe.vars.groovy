...
BOWTIE_INSERT="-l 22"			// seed size. Match with fragment size
BOWTIE_MM_SEED="-n 1"			// number of mismatches allowed in the seed
BOWTIE_MAQERR=""			// max sum of quals for -n mismatches
BOWTIE_MULTIMAP="-m 1"			// discard reads mapping to more than MULTIMAP positions
BOWTIE_BEST="--best --strata --chunkmbs 256"	// bowtie best mode, this does not apply to paired end
