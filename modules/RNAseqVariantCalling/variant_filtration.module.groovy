...
VariantFiltration = {
   ...
   transform (".vcf.gz") to (".filtered.vcf.gz") {
      ...
      exec """
            ...
            ${TOOL_JAVA}/java ${JAVA_FLAGS} -jar ${TOOL_GATK}/GenomeAnalysisTK.jar -T VariantFiltration -V $input -o $output -window 35 -cluster 3 -filterName FS -filter "FS > 30.0" -filterName QD -filter "QD < 2.0" ${GATK_FLAGS}
