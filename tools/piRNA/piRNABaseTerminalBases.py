...
def getArgs():
  ...
  parser.add_argument('-i','--intervals', required=True, type=str,
  ...
  parser.add_argument('-u','--upstream', required=False, type=int, default=20,
  help='Number of nucleotides upstream of the read (genomic sequence). Default is 20')

  parser.add_argument('-d','--downstream', required=False, type=int, default=20,
