...
threshold_rel_countssum  <- parseArgs(args,"threshold_rel_countssum=", 0)  
excludeSeqsNotInAllFractions  <- parseArgs(args,"excludeSeqsNotInAllFractions=", FALSE)  
...
excludeSeqsNotInAllFractions = T # discard all sequences per sub_experiment, which were not detected in all fractions of this sub_eperiment
