...
table.content <- data.frame(  tool=c(
							  ...
							  version=c(
									  ...
									  Toolhelper.VersionReporter("BWA",    SHINYREPS_BWA_LOG),
									  Toolhelper.VersionReporter("Picard", SHINYREPS_MARKDUPS_LOG),
									  Toolhelper.VersionReporter("GATK UnifiedGenotyper", SHINYREPS_GATKug_LOG),
									  Toolhelper.VersionReporter("GATK HaplotypeCaller",  SHINYREPS_GATKhc_LOG)
									  )
						   )
kable(table.content)
