...
for(i in 1:nrow(conts)) {
	...
	cat("Volcano plot of all DESeq2-tested genes depicting their expression fold change vs. statistical significance:", "\n", "\n")
	...
	cat("##### Top hits", fill=T)
        cat("", fill=T)
	cat("The table shows the top 25 DEGs with their mean expression change (log2 of fold change) and statistical significance (padj, FDR-adjusted p-value):", fill=T)
	cat("", fill=T)
