...
for(i in 1:nrow(conts)) {
    ...
    Pathway_network_up <- paste0(SHINYREPS_GO_ENRICHMENT, "/", gsub("=.*", "", conts[i, 1]), "_Reactome_network_up_genes.png")
    ...
    Pathway_network_down <- paste0(SHINYREPS_GO_ENRICHMENT, "/", gsub("=.*", "", conts[i, 1]), "_Reactome_network_down_genes.png")
