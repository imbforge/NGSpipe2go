...
```{r diff_splicing_contrastplots, echo=F, results='asis', error=F, warning=F, message=F, fig.align="center", out.width="90%", fig.height=4.5}
...
for(i in 1:length(uconts_vec)) {
    ...
    if(file.exists(file.path(SHINYREPS_RES, "rMATS", paste0(uconts_vec[i],"_rMATS"),"maser_processed.RData")) &&
        ...
        DEhelper.subchunkify(rmats_stats$plotspldist$p.count.cond,
                             fig_height = 3.5,
                             fig_width  = 7,
                             cntr = T,
                             out_width = T,
...
e adding up to 100%.\n",fill=T)
        DEhelper.subchunkify(rmats_stats$plotspldist$p.perc.cond,
                             fig_height = 3.5,
                             fig_width  = 7,
                             cntr = T,
                             out_width = T,
...
ighter shade of the bars.\n",fill=T)
        DEhelper.subchunkify(rmats_stats$plotspldist$p.count.type,
                             fig_height = 3.5,
                             fig_width  = 7,
                             cntr = T,
                             out_width = T,
...
or lighter shade of the bars.\n",fill=T)
        DEhelper.subchunkify(rmats_stats$plotspldist$p.perc.type,
                             fig_height = 3.5,
                             fig_width  = 7,
                             cntr = T,
                             out_width = T,
