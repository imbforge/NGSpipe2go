...
```{r echo=F,error=F,warning=F,message=F,fig.align="center"}
...
```{r echo=F,results='asis',error=F,warning=F,message=F,fig.align="center"}
...
table.content <- data.frame(  tool=c(
							  ...
							  version=c(
									  Toolhelper.VersionFastQC(),
									  Toolhelper.VersionSTAR(),
									  Toolhelper.VersionSamtools(),
									  Toolhelper.VersionSubread(),
									  Toolhelper.VersionPicard(),
									  Toolhelper.VersionGeneBodyCoverage(),
									  Toolhelper.VersionEdgeR(),
									  Toolhelper.VersionDEseq()
									  )
						   )
kable(table.content)
