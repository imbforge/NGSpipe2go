...
if("p_per_replicate_splitByReplicate" %in% names(plot_list)){
  cat("#### Gene body coverage per sample split by replicate, colored by group: \n", fill=T)
  plot(plot_list$p_per_replicate_splitByReplicate)
  cat("\n", fill=T)
}
```
