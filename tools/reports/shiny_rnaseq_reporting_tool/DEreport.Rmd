...
The maser package is used to enable the functional characterization of splicing in transcriptomic contexts. In a nutshell, maser allows a detailed analysis of splicing events by filtering the rMATS results based on RNA-seq coverage, p-values and differential percent spliced-in (PSI), analysis of global splicing effects using PCA and Volcano plots, mapping of splicing events to Ensembl transcripts and visualization of transcripts affected by splicing using custom Gviz plots.
...
## Additional differential expression analysis including multimapped reads ##
