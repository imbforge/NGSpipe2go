...
For the anlyses below, the FC filter was set to `r SHINYREPS_DE_DESEQ_FC` (note: FC=1 means no FC filter) and the FDR filter was set to `r SHINYREPS_DE_DESEQ_FDR`.
...
for(i in 1:nrow(conts)) {
    ...
    GO_bar_up     <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_GO_Barplot_up_genes.png")
    GO_treemap_up <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_GO_treemap_up_genes.png")
    GO_cnet_up    <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_GO_cnetplot_up_genes.png")
    GO_table_up   <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_GO_Enrichment_up_genes.csv")
    ...
    GO_bar_down     <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_GO_Barplot_down_genes.png")
    GO_treemap_down <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_GO_treemap_down_genes.png")
    GO_cnet_down    <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_GO_cnetplot_down_genes.png")
    GO_table_down   <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_GO_Enrichment_down_genes.csv")
    ...
    if(file.exists(GO_bar_down)) {
     ...
     Pathway_bar_up     <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_Reactome_Barplot_up_genes.png")
     Pathway_table_up   <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_Reactome_Pathway_Enrichment_up_genes.csv")
    ...
    Pathway_bar_down     <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_Reactome_Barplot_down_genes.png")
    Pathway_table_down   <- paste0(SHINYREPS_GO_ENRICHMENT, "/", conts$contrast.name[i], "_Reactome_Pathway_Enrichment_down_genes.csv")
