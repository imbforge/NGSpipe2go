...
#### Competitive mapping to rRNAs and the genome

A competitive mapping to the reference genome and all known rRNAs was performed with FastQScreen (http://www.bioinformatics.babraham.ac.uk/projects/fastq_screen/).

```{r fastqscreen_paragraph, echo=F, results='asis', error=F, warning=F, message=F}
cat(DEhelper.fastqscreen(), sep="\n")
```
