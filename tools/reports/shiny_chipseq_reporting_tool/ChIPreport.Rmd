...
```{r peak_annotation_coverage_combined, echo=F, results='asis', error=F, fig.width= 10, warning=F, message=F}
if(length(branches)>1) {
cat("\n\n#### Overlap of peaks from different pipeline branches\n")  
