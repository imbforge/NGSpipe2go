...
if (SHINYREPS_FASTQC_SUMMARIZED == FALSE && "BaseQuals" %in% names(fastqc_summary_plot)) {
    cat(qctext["BaseQuals"])
    plot(fastqc_summary_plot[["BaseQuals"]])
}
```
...
if (SHINYREPS_FASTQC_SUMMARIZED == FALSE && "SeqContent" %in% names(fastqc_summary_plot)) {
    cat(qctext["SeqContent"])
    plot(fastqc_summary_plot[["SeqContent"]])
} 
```
