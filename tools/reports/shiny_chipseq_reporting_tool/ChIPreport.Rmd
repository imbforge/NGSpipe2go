...
ChIPhelper.ngsReports.Fastqc(samplePattern="cutadapt", exclude=T)
```
...
```{r FastQC_paragraph, echo=F,results='asis',error=F,warning=F,message=F,fig.align='center', eval=runCutadapt}
cat("## FastQC after adapter trimming\n")
ChIPhelper.ngsReports.Fastqc(samplePattern="cutadapt")
```
