...
### Mapping ###
Mapping was done using Bowtie. The mapping statistics show the total number of reads delivered to the aligner ("all reads"), the number of "mapped" reads, the reads that failed to align ("unmapped"), the number of reads discarded because of mapping to multiple positions ("too many map. pos.") and the number of duplicate reads ("duplicates") amongst the mapped reads:
