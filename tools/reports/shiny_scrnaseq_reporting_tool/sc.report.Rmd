...
# targets$file must be a substring of file name). Otherwise pruned file names will be used by default.
#####
...
DEhelper.cutadapt(colorByFactor="group", targetsdf=targets4plots)
```
