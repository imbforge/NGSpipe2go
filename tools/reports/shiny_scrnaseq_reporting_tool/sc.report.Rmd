...
```{r GeneBodyCoverage_paragraph_per_sample, echo=F, error=F, warning=F, message=F, results='asis', fig.align="center"}
...
```{r strandspecificity,  echo=F, results='asis', error=F, warning=F, message=F, eval=file.exists(SHINYREPS_INFEREXPERIMENT_LOGS)}
