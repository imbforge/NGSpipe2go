...
switch(SHINYREPS_SEQTYPE,
    ...
    tenX={
      ...
      group.vars <- colnames(targets)[!colnames(targets) %in% c("cell_id", "sample")] 
      targets4plots <- targets_pools
...
DEhelper.cutadapt(colorByFactor=colorByFactor, targetsdf=targets4plots, outlierIQRfactor=10)
```
