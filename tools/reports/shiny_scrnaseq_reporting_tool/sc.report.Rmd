...
attach_packages(c("rmarkdown", "knitr", "Cairo", "gplots", "ggplot2", "plotly", "RColorBrewer", "ggrepel", "parallel",
                  ...
                  "igraph", "pheatmap", "cluster", "dendextend", "dynamicTreeCut", "shinydashboard", "umap"))
...
## create targets4plot (needed for pool-based libraries like MARS-Seq with 1 count file for all samples of a pool)
  ...
  targets4plot <- lapply(targets4plot, factor)
  } else {
...
annoFactors <- SHINYREPS_COLORBYFACTOR # default is group.vars
#####

annoFactors <- unique(c(annoFactors, "cells")) # cells is included anyway
