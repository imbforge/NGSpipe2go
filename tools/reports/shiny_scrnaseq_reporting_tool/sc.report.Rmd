...
switch(SHINYREPS_SEQTYPE,
    ...
    tenX={
      ...
      # define group.vars
      demux_columns <- c("GEMwell","HTO_maxID","nCount_HTO","HTO_secondID", "HTO_margin", "file_HTO","seq_HTO","samplename_suffix_HTO")
...
```{r demux, echo=F, message=FALSE, results='asis', eval=as.logical(SHINYREPS_RUN_DEMUX)}
