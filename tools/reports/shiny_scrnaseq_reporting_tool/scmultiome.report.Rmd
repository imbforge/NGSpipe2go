...
sobj <- get_network_graph(sobj, rna_assay = "SCT")
cat("Visualization of the network graph")
pnetg <- plot_network_graph(sobj, layout = "umap") + ggtitle("Network graph")
pnetg
